...
public class HistoryCard$$ViewBinder<T extends HistoryCard> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131296389, "field 'chart'");
    target.chart = finder.castView(view, 2131296389, "field 'chart'");
    view = finder.findRequiredView(source, 2131296528, "field 'title'");
    target.title = finder.castView(view, 2131296528, "field 'title'");
    view = finder.findRequiredView(source, 2131296360, "method 'onClickEditButton'");
    unbinder.view2131296360 = view;
