...
public class ScoreCard$$ViewBinder<T extends ScoreCard> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131296497, "field 'spinner' and method 'onItemSelected'");
    target.spinner = finder.castView(view, 2131296497, "field 'spinner'");
    unbinder.view2131296497 = view;
    ...
    view = finder.findRequiredView(source, 2131296466, "field 'chart'");
    target.chart = finder.castView(view, 2131296466, "field 'chart'");
  ...
  protected static class InnerUnbinder<T extends ScoreCard> implements Unbinder {
    ...
    protected void unbind(T target) {
      ((AdapterView<?>) view2131296497).setOnItemSelectedListener(null);
      target.spinner = null;
      target.chart = null;
      target.title = null;
    }
